    ...
    VSFrame* vs_frame, VSFrameContext* frame_ctx, const VSAPI* vsapi)
{
    vs_picture_t vs_picture = { /* data */
        ...
        /* linesize */
        { vsapi->getStride(vs_frame, 0), vsapi->getStride(vs_frame, 1), vsapi->getStride(vs_frame, 2), 0 }
    };
    if (vshp->input_pixel_format == AV_PIX_FMT_P010LE && vshp->output_pixel_format == AV_PIX_FMT_YUV420P10LE) {
        ...
        planar_yuv_sse2(dstp_y, dstp_u, dstp_v, srcp_y, srcp_uv, dst_stride_y, dst_stride_uv, src_stride_y, src_stride_uv, width_y,
            width_uv, height_y, height_uv);
#else
        sws_scale(vshp->sws_ctx, (const uint8_t* const*)av_picture->data, av_picture->linesize, 0, av_picture->height, vs_picture.data,
            vs_picture.linesize);
#endif // SSE2_ENABLED
    } else
        sws_scale(vshp->sws_ctx, (const uint8_t* const*)av_picture->data, av_picture->linesize, 0, av_picture->height, vs_picture.data,
    ...
    VSFrame* vs_frame, VSFrameContext* frame_ctx, const VSAPI* vsapi)
{
    vs_picture_t vs_picture = { /* data */
        ...
        /* linesize */
        { vsapi->getStride(vs_frame, 0), 0, 0, 0 }
    };
    sws_scale(vshp->sws_ctx, (const uint8_t* const*)av_picture->data, av_picture->linesize, 0, av_picture->height, vs_picture.data,
        vs_picture.linesize);
}
    ...
    VSFrame* vs_frame, VSFrameContext* frame_ctx, const VSAPI* vsapi)
{
    vs_picture_t vs_picture = { /* data */
        { vsapi->getWritePtr(vs_frame, component_reorder[0]), vsapi->getWritePtr(vs_frame, component_reorder[1]),
            vsapi->getWritePtr(vs_frame, component_reorder[2]), NULL },
        /* linesize */
        { vsapi->getStride(vs_frame, component_reorder[0]), vsapi->getStride(vs_frame, component_reorder[1]),
            vsapi->getStride(vs_frame, component_reorder[2]), 0 }
...
static enum AVPixelFormat vs_to_av_output_pixel_format(VSPresetVideoFormat vs_output_pixel_format)
{
    static const struct {
        ...
        { pfYUV420P9, AV_PIX_FMT_YUV420P9LE }, { pfYUV422P9, AV_PIX_FMT_YUV422P9LE }, { pfYUV444P9, AV_PIX_FMT_YUV444P9LE },
        { pfYUV420P10, AV_PIX_FMT_YUV420P10LE }, { pfYUV422P10, AV_PIX_FMT_YUV422P10LE }, { pfYUV444P10, AV_PIX_FMT_YUV444P10LE },
        { pfYUV420P12, AV_PIX_FMT_YUV420P12LE }, { pfYUV422P12, AV_PIX_FMT_YUV422P12LE }, { pfYUV444P12, AV_PIX_FMT_YUV444P12LE },
...
static const component_reorder_t* get_component_reorder(enum AVPixelFormat av_output_pixel_format)
{
    static const struct {
        ...
        { AV_PIX_FMT_YUV420P, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV422P, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV444P, { 0, 1, 2, -1 } },
        { AV_PIX_FMT_YUV410P, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV411P, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV440P, { 0, 1, 2, -1 } },
        { AV_PIX_FMT_YUV420P9LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV422P9LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV444P9LE, { 0, 1, 2, -1 } },
        { AV_PIX_FMT_YUV420P10LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV422P10LE, { 0, 1, 2, -1 } },
        { AV_PIX_FMT_YUV444P10LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV420P12LE, { 0, 1, 2, -1 } },
        { AV_PIX_FMT_YUV422P12LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV444P12LE, { 0, 1, 2, -1 } },
        { AV_PIX_FMT_YUV420P14LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV422P14LE, { 0, 1, 2, -1 } },
        { AV_PIX_FMT_YUV444P14LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV420P16LE, { 0, 1, 2, -1 } },
        { AV_PIX_FMT_YUV422P16LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUV444P16LE, { 0, 1, 2, -1 } }, { AV_PIX_FMT_YUVA420P, { 0, 1, 2, 3 } },
        { AV_PIX_FMT_YUVA422P, { 0, 1, 2, 3 } }, { AV_PIX_FMT_YUVA444P, { 0, 1, 2, 3 } }, { AV_PIX_FMT_YUVA420P9LE, { 0, 1, 2, 3 } },
        { AV_PIX_FMT_YUVA422P9LE, { 0, 1, 2, 3 } }, { AV_PIX_FMT_YUVA444P9LE, { 0, 1, 2, 3 } }, { AV_PIX_FMT_YUVA420P10LE, { 0, 1, 2, 3 } },
        { AV_PIX_FMT_YUVA422P10LE, { 0, 1, 2, 3 } }, { AV_PIX_FMT_YUVA444P10LE, { 0, 1, 2, 3 } },
        { AV_PIX_FMT_YUVA422P12LE, { 0, 1, 2, 3 } }, { AV_PIX_FMT_YUVA444P12LE, { 0, 1, 2, 3 } },
        { AV_PIX_FMT_YUVA420P16LE, { 0, 1, 2, 3 } }, { AV_PIX_FMT_YUVA422P16LE, { 0, 1, 2, 3 } },
        ...
        { AV_PIX_FMT_RGBA64BE, { 0, 1, 2, 3 | component_reorder_bigendian } }, { AV_PIX_FMT_XYZ12LE, { 0, 1, 2, -1 } },
...
static inline int set_frame_maker(vs_video_output_handler_t* vs_vohp, int output_index)
{
    static const struct {
    ...
    } frame_maker_table[] = { { pfYUV420P8, 0, make_black_background_planar_yuv8, make_frame_planar_yuv },
        ...
        { pfYUV444P16, 0, make_black_background_planar_yuv16, make_frame_planar_yuv }, { pfYUV420P8, 1, NULL, make_frame_planar_alpha },
        { pfYUV422P8, 1, NULL, make_frame_planar_alpha }, { pfYUV444P8, 1, NULL, make_frame_planar_alpha },
        { pfYUV420P9, 1, NULL, make_frame_planar_alpha }, { pfYUV422P9, 1, NULL, make_frame_planar_alpha },
        { pfYUV444P9, 1, NULL, make_frame_planar_alpha }, { pfYUV420P10, 1, NULL, make_frame_planar_alpha },
        { pfYUV422P10, 1, NULL, make_frame_planar_alpha }, { pfYUV444P10, 1, NULL, make_frame_planar_alpha },
        { pfYUV422P12, 1, NULL, make_frame_planar_alpha }, { pfYUV444P12, 1, NULL, make_frame_planar_alpha },
        { pfYUV420P16, 1, NULL, make_frame_planar_alpha }, { pfYUV422P16, 1, NULL, make_frame_planar_alpha },
        { pfYUV444P16, 1, NULL, make_frame_planar_alpha }, { pfGray8, 0, make_black_background_planar_gray, make_frame_planar_gray },
...
static int determine_colorspace_conversion(
    vs_video_output_handler_t* vs_vohp, int output_index, enum AVPixelFormat input_pixel_format, enum AVPixelFormat* output_pixel_format)
{
    ...
    static const struct {
        ...
        { AV_PIX_FMT_YVYU422, pfYUV422P8, 1 }, { AV_PIX_FMT_NV16, pfYUV422P8, 1 }, { AV_PIX_FMT_YUV444P, pfYUV444P8, 0 },
        { AV_PIX_FMT_NV24, pfYUV444P8, 1 }, { AV_PIX_FMT_NV42, pfYUV444P8, 1 }, { AV_PIX_FMT_YUV410P, pfYUV410P8, 0 },
        { AV_PIX_FMT_YUV411P, pfYUV411P8, 0 }, { AV_PIX_FMT_UYYVYY411, pfYUV411P8, 1 }, { AV_PIX_FMT_YUV440P, pfYUV440P8, 0 },
        { AV_PIX_FMT_YUV420P9LE, pfYUV420P9, 0 }, { AV_PIX_FMT_YUV420P9BE, pfYUV420P9, 1 }, { AV_PIX_FMT_YUV422P9LE, pfYUV422P9, 0 },
        { AV_PIX_FMT_YUV422P9BE, pfYUV422P9, 1 }, { AV_PIX_FMT_YUV444P9LE, pfYUV444P9, 0 }, { AV_PIX_FMT_YUV444P9BE, pfYUV444P9, 1 },
        { AV_PIX_FMT_YUV420P10LE, pfYUV420P10, 0 }, { AV_PIX_FMT_YUV420P10BE, pfYUV420P10, 1 }, { AV_PIX_FMT_P010LE, pfYUV420P10, 1 },
        { AV_PIX_FMT_P010BE, pfYUV420P10, 1 }, { AV_PIX_FMT_YUV422P10LE, pfYUV422P10, 0 }, { AV_PIX_FMT_YUV422P10BE, pfYUV422P10, 1 },
        { AV_PIX_FMT_NV20LE, pfYUV422P10, 1 }, { AV_PIX_FMT_NV20BE, pfYUV422P10, 1 }, { AV_PIX_FMT_Y210LE, pfYUV422P10, 1 },
        { AV_PIX_FMT_Y210BE, pfYUV422P10, 1 }, { AV_PIX_FMT_YUV444P10LE, pfYUV444P10, 0 }, { AV_PIX_FMT_YUV444P10BE, pfYUV444P10, 1 },
        { AV_PIX_FMT_YUV420P12LE, pfYUV420P12, 0 }, { AV_PIX_FMT_YUV420P12BE, pfYUV420P12, 1 }, { AV_PIX_FMT_YUV422P12LE, pfYUV422P12, 0 },
        { AV_PIX_FMT_YUV422P12BE, pfYUV422P12, 1 }, { AV_PIX_FMT_YUV444P12LE, pfYUV444P12, 0 }, { AV_PIX_FMT_YUV444P12BE, pfYUV444P12, 1 },
        { AV_PIX_FMT_YUV420P14LE, pfYUV420P14, 0 }, { AV_PIX_FMT_YUV420P14BE, pfYUV420P14, 1 }, { AV_PIX_FMT_YUV422P14LE, pfYUV422P14, 0 },
        { AV_PIX_FMT_YUV422P14BE, pfYUV422P14, 1 }, { AV_PIX_FMT_YUV444P14LE, pfYUV444P14, 0 }, { AV_PIX_FMT_YUV444P14BE, pfYUV444P14, 1 },
        { AV_PIX_FMT_YUV420P16LE, pfYUV420P16, 0 }, { AV_PIX_FMT_YUV420P16BE, pfYUV420P16, 1 }, { AV_PIX_FMT_P016LE, pfYUV420P16, 1 },
        { AV_PIX_FMT_P016BE, pfYUV420P16, 1 }, { AV_PIX_FMT_YUV422P16LE, pfYUV422P16, 0 }, { AV_PIX_FMT_YUV422P16BE, pfYUV422P16, 1 },
        { AV_PIX_FMT_YUV444P16LE, pfYUV444P16, 0 }, { AV_PIX_FMT_YUV444P16BE, pfYUV444P16, 1 }, { AV_PIX_FMT_YUVA420P, pfYUV420P8, 1 },
        { AV_PIX_FMT_YUVA422P, pfYUV422P8, 1 }, { AV_PIX_FMT_YUVA444P, pfYUV444P8, 1 }, { AV_PIX_FMT_YUVA420P9LE, pfYUV420P9, 1 },
        { AV_PIX_FMT_YUVA422P9LE, pfYUV422P9, 1 }, { AV_PIX_FMT_YUVA444P9LE, pfYUV444P9, 1 }, { AV_PIX_FMT_YUVA420P10LE, pfYUV420P10, 1 },
        { AV_PIX_FMT_YUVA422P10LE, pfYUV422P10, 1 }, { AV_PIX_FMT_YUVA444P10LE, pfYUV444P10, 1 },
        { AV_PIX_FMT_YUVA422P12LE, pfYUV422P12, 1 }, { AV_PIX_FMT_YUVA444P12LE, pfYUV444P12, 1 },
        { AV_PIX_FMT_YUVA420P16LE, pfYUV420P16, 1 }, { AV_PIX_FMT_YUVA422P16LE, pfYUV422P16, 1 },
        { AV_PIX_FMT_YUVA444P16LE, pfYUV444P16, 1 }, { AV_PIX_FMT_GRAY8, pfGray8, 0 }, { AV_PIX_FMT_GRAY9LE, pfGray16, 1 },
        { AV_PIX_FMT_GRAY9BE, pfGray16, 1 }, { AV_PIX_FMT_GRAY10LE, pfGray16, 1 }, { AV_PIX_FMT_GRAY10BE, pfGray16, 1 },
...
static int get_output_video_format(
    vs_video_output_handler_t* vs_vohp, int output_index, VSVideoFormat* vs_format, VSCore* core, const VSAPI* vsapi)
{
    if (!vsapi->getVideoFormatByID(vs_format, vs_vohp->vs_output_pixel_format, core))
        return -1;
    if (output_index == 1
        && !vsapi->queryVideoFormat(vs_format, cfGray, vs_format->sampleType, vs_format->bitsPerSample, 0, 0, core))
        return -1;
    return 0;
}
    ...
    enum AVPixelFormat* output_pixel_format, int input_pix_fmt_change, VSFrameContext* frame_ctx, VSCore* core, const VSAPI* vsapi)
{
    if (vs_vohp->variable_info) {
        ...
        if (get_output_video_format(vs_vohp, output_index, &vs_format, core, vsapi) < 0)
            goto fail;
...
VSFrame* make_frame(lw_video_output_handler_t* vohp, AVFrame* av_frame, int output_index)
{
    ...
    if (av_frame->opaque) {
        ...
        return vs_vbhp ? (VSFrame*)vs_vbhp->vsapi->addFrameRef(vs_vbhp->vs_frame_buffer) : NULL;
    }
    /* Make video frame.
...
static int vs_check_dr_available(AVCodecContext* ctx, enum AVPixelFormat pixel_format)
{
    if (!(ctx->codec->capabilities & AV_CODEC_CAP_DR1))
        return 0;
    static enum AVPixelFormat dr_support_pix_fmt[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_YUV444P, AV_PIX_FMT_YUV410P,
        AV_PIX_FMT_YUV411P, AV_PIX_FMT_YUV440P, AV_PIX_FMT_YUV420P9LE, AV_PIX_FMT_YUV422P9LE, AV_PIX_FMT_YUV444P9LE, AV_PIX_FMT_YUV420P10LE,
...
static void vs_video_release_buffer_handler(void* opaque, uint8_t* data)
{
...
static void vs_video_unref_buffer_handler(void* opaque, uint8_t* data)
{
...
static inline int vs_create_plane_buffer(
    vs_video_buffer_handler_t* vs_vbhp, AVBufferRef* vs_buffer_handler, AVFrame* av_frame, int av_plane, int vs_plane)
{
...
static int vs_video_get_buffer(AVCodecContext* ctx, AVFrame* av_frame, int flags)
{
    ...
    if ((!vs_vohp->variable_info && lw_vohp->scaler.output_pixel_format != pix_fmt) || !vs_check_dr_available(ctx, pix_fmt))
...
int vs_setup_video_rendering(lw_video_output_handler_t* lw_vohp, AVCodecContext* ctx, VSVideoInfo* vi, VSMap* out, int width, int height)
{
    ...
    if (vs_vohp->variable_info) {
        ...
        if (!vsapi->getVideoFormatByID(&vi->format, vs_vohp->vs_output_pixel_format, vs_vohp->core)) {
            set_error_on_init(out, vsapi, "lsmas: failed to resolve the output format.");
            return -1;
        }
...
static void vs_free_video_output_handler(void* private_handler)
{
    ...
    int bottom, const VSAPI* vsapi, int n)
{
    ...
    /* Sample aspect ratio */
    vsapi->mapSetInt(props, "_SARNum", av_frame->sample_aspect_ratio.num, maReplace);
    vsapi->mapSetInt(props, "_SARDen", av_frame->sample_aspect_ratio.den, maReplace);
    /* Sample duration */
    ...
    vsapi->mapSetData(props, "_PictType", &pict_type, 1, dtBinary, maReplace);
    /* BFF or TFF */
    int field_based = 0;
